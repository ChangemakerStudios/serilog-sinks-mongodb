...
namespace Serilog.Events
{
    ...
    public class MessageTemplate
    {
        ...
        public MessageTemplate(string text, IEnumerable<MessageTemplateToken> tokens)
        {
            ...
            var propertyTokens = GetElementsOfTypeToArray<Formatting.Json.PropertyToken>(_tokens);
        ...
        internal Formatting.Json.PropertyToken[] NamedProperties { get; }

        internal Formatting.Json.PropertyToken[] PositionalProperties { get; }
